...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
            fc1_dims=128, fc2_dims=64, fc3_dims=64, chkpt_dir='tmp/ppo'):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1_dims=128, fc2_dims=64, fc3_dims=64,
            chkpt_dir='tmp/ppo'):
...
class Agent:
    ...
    def choose_action(self, observation):
        # state = T.tensor([observation], dtype=T.float).to(self.actor.device)          # ORIGINAL
